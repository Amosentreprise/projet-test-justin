    ...
    return ( 
        <div className=" min-h-screen bg-white  font-open">
            <div className=" space-y-5">
                 ...
                 <h2 className=" text-2xl text-accent-orange text-center font-bold max-w-[400px] mx-auto">See How Can Help</h2>
            </div>
            ...
            <div className="w-[80%] mx-auto flex gap-5 justify-evenly flex-wrap items-center py-8">
                {
                    services.map((service)=>{
                        ...
                        <div className=" w-[300px] flex flex-col" key={service.id}>
                            <div className="relative mx-auto w-20 h-20 bg-accent rounded-t-full flex ">
                            ...
                            <h3 className=" text-xl text-accent-orange font-bold text-center">{service.title}</h3>
