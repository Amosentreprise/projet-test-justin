...
const Property = () => {
    ...
    return ( 
        <div className=" min-h-screen bg-primary flex p-10 w-full relative overflow-hidden ">
            ...
            <h2 className=" text-accent font-kufam text-2xl font-bold text-center">Properties for sale in your favorite area</h2>
            ...
            <div className="w-[300px] p-20 rounded-t-full bg-[#EEC1AC] absolute bottom-0 left-1/2 transform -translate-x-1/2 z-30 flex justify-center items-center">
                <button className="bg-white p-2 text-accent font-kufam rounded-lg cursor-pointer z-40">
                    Touch with us
                </button>
            </div>
