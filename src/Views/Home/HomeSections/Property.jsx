...
const Property = () => {
    return ( 
        <div className=" min-h-screen bg-primary flex sm:p-2 md:p-10 lg:p-10 w-full relative overflow-hidden ">
            ...
            <h2 className=" text-accent font-open text-2xl font-bold text-center">Properties for sale in your favorite area</h2>
              ...
              <div className="sm:w-full md:w-[80%] lg:w-[80%] pt-9 pb-24 flex flex-wrap justify-center gap-10 mx-auto relative z-40">
                  {
                    datas.map((data)=>{
                        return(
