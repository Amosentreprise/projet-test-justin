...
const About = () => {
    ...
    return ( 
        <div className="min-h-screen bg-white py-6 font-open overflow-hidden" >
            ...
            <div className=" min-h-[calc(100vh-9rem)] bg-secondary relative flex overflow-hidden " >
              <img src={pattern} alt="" className=" absolute left-0 z-20" />
                <div className=" flex relative z-40 my-auto " data-aos="fade-up" data-aos-duration="2000">
