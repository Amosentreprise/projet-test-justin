...
const LearnMore = () => {
    return ( 
        <div className=" w-[80%] mx-auto space-y-8 min-h-[500px] flex flex-col font-open  py-8">
            <div className=" flex items-center sm:justify-center md:justify-center lg:justify-between flex-wrap gap-2">
               <div className="max-w-[500px]">
                 <img src={blog1} alt="" className="w-full h-auto object-cover" />
               </div>
               <div className=" max-w-[500px]">
                 <h2 className=" text-3xl text-accent font-bold">Learn More About Who We Are in Real Estate</h2>
            ...
            <div className=" flex  sm:justify-center md:justify-center lg:justify-between flex-wrap gap-2">
               <div className=" max-w-[500px] space-y-2">
                 <h2 className=" text-3xl text-accent-orange font-bold">We're reinventing the space</h2>
                 <p className="text-amber-700">Distinctively re-engineer revolutionary meta-services and premium  At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolore.</p>
                 <div>
